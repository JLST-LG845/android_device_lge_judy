...
ucnv_open_68(const char *converterName, UErrorCode *err)
{
    return ucnv_open(converterName, err);
}

U_STABLE void  U_EXPORT2
ucnv_close_68(UConverter * converter)
{
    return ucnv_close(converter);
}

U_STABLE void U_EXPORT2 UCNV_TO_U_CALLBACK_STOP_68(
                  const void *context,
...
U_STABLE void U_EXPORT2 UCNV_FROM_U_CALLBACK_STOP_68(
                  const void *context,
...
U_STABLE void U_EXPORT2
ucnv_setToUCallBack_68(UConverter * converter,
...
U_STABLE void U_EXPORT2
ucnv_setFromUCallBack_68(UConverter * converter,
...
U_STABLE void U_EXPORT2
ucnv_convertEx_68(UConverter *targetCnv, UConverter *sourceCnv,
